            ...
            <div class="card">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('employees.update', $employee->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ old('name', $employee->name) }}" required autocomplete="name" autofocus>                               
                            </div>
                        </div>   
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control" name="surname" value="{{ old('surname', $employee->surname) }}" required autocomplete="surname" autofocus>                               
                            </div>
                        </div> 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control" name="phone" value="{{ old('phone', $employee->phone) }}" required autocomplete="phone" autofocus>                               
                            </div>
                        </div>                         
